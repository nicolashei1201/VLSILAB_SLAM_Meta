...
find_path(EFUSION_INCLUDE_DIR ElasticFusion.h
          PATHS
            ${CMAKE_CURRENT_SOURCE_DIR}/../ElasticFusionWithICPORBVO/Core/src
          PATH_SUFFIXES Core
)
...
find_library(EFUSION_LIBRARY
             NAMES libefusion.so
             PATHS
               ${CMAKE_CURRENT_SOURCE_DIR}/../ElasticFusionWithICPORBVO/Core/build
               ${CMAKE_CURRENT_SOURCE_DIR}/../ElasticFusionWithICPORBVO/Core/src/build
