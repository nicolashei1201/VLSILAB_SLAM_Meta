...
public:
  ...
  double sindex(){
    return accSlidingExtent;
  }
  double condition_number(){
	return cons_number;
  }
  double condition_number56(){
	return cons_number56;
  }
...
bool MatchingByProject2DAndWalk1(const SourceCloud& srcCloud, const TargetCloud& tgtCloud);
bool MatchingByProject2DAndWalk2(const SourceCloud& srcCloud, const TargetCloud& tgtCloud);
bool MatchingByProject2DAndWalk3(const SourceCloud& srcCloud, const TargetCloud& tgtCloud);
bool MatchingByProject2DAndWalk4(const SourceCloud& srcCloud, const TargetCloud& tgtCloud);
 ...
 Eigen::Matrix<int, Eigen::Dynamic, 2, Eigen::RowMajor> corrs1;
  Eigen::Matrix<int, Eigen::Dynamic, 2, Eigen::RowMajor> corrs2;
   Eigen::Matrix<int, Eigen::Dynamic, 2, Eigen::RowMajor> corrs3;
    Eigen::Matrix<int, Eigen::Dynamic, 2, Eigen::RowMajor> corrs4;
  //Minimizing datas
  double accSlidingExtent;
  double thresAccSlidingExtent;
  double thresEvalRatio;
  double cons_number;
  double cons_number56;
};
#endif /* EAS_ICP_H */
